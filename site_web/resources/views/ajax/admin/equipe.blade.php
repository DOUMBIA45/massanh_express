...
<script>
    ...
    $(document).ready(function(){
        $('#UploadServices').click(function (e){
            ...
            var l_facebook = $('input[name="l_facebook"]').val();
            var l_twitter = $('input[name="l_twitter"]').val();
            var l_linkedin = $('input[name="l_linkedin"]').val();
            ...
            if(nom.length == '' || fonction.length == '' || image_empty.length ==''){
                ...
                formData.append("l_facebook",l_facebook);
                formData.append("l_twitter",l_twitter);
                formData.append("l_linkedin",l_linkedin);
