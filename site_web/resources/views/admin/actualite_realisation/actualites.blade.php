                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-header-action">
                            <a href="#" class="btn btn-primary modal_service"><i class="fa fa-eye"></i> Ajouter une actualité</a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped mb-0">
                                ...
                                <tbody>
                                @foreach($actualistes as $actualiste)
                                    <tr>
                                        <td>
                                            @if($actualiste->image)
                                                <a href="#">
                                                    <img src="{{asset(env('ACTUALITE_ASSET').'/'.$actualiste->image)}}" alt="avatar" width="80" class="rounded mr-1">
                                                </a>
                                            @else
                                                <a href="#">
                                        ...
                                        <td>{!! $actualiste->description !!}</td>
                                        <td>
                                            <a class="btn btn-danger btn-action" data-toggle="tooltip" title="Delete" data-confirm="Etes-vous sûr ?|Cette action peut être annulée. Voulez-vous continuer ?" data-confirm-yes="deleteActualite({{$actualiste->id}})"><i class="fas fa-trash"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
